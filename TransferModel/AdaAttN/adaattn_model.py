...
class AdaAttNModel(nn.Module):
    def __init__(self, encoder_path, decoder_path, adaattn_3_path, adaattn_4_5_path):
        ...
        self.net_decoder.load_state_dict(torch.load(decoder_path, weights_only=True))
        self.net_transformer.load_state_dict(torch.load(adaattn_4_5_path, weights_only=True))
        self.net_adaattn_3.load_state_dict(torch.load(adaattn_3_path, weights_only=True))
